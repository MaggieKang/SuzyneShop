...
@Configuration
//@MapperScan(basePackages = "com.suzyne.shop.domain.*.srypos.dao", sqlSessionFactoryRef = "sryposSqlSessionFactory")
@MapperScan(value = "com.suzyne.shop.domain", annotationClass=SryposConnMapper.class, sqlSessionFactoryRef = "sryposSqlSessionFactory")
